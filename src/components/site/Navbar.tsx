...
import logo from "@/assets/badaie-logo.webp";
...
const NAV = [
  ...
  { to: "/projects", label: "Capabilities" },
  { to: "/clients", label: "Work With Us" },
      ...
      <div className="container-x flex h-20 items-center justify-between gap-4">
        <Link to="/" className="inline-flex flex-nowrap items-center gap-2 sm:gap-3 shrink-0 group" onClick={() => setOpen(false)}>
          ...
          <div className="flex flex-col justify-center min-w-0 leading-tight">
            ...
            <div className="text-gold text-[8px] sm:text-[9px] lg:text-[10px] tracking-[0.14em] sm:tracking-[0.18em] lg:tracking-[0.28em] uppercase whitespace-nowrap">HEAVY GEN.CONT.EST</div>
          </div>
        </Link>
