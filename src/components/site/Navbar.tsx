  ...
  return (
    ...
    >
      <div className="container-x flex h-20 items-center justify-between gap-4">
        <Link to="/" className="flex items-center gap-2.5 sm:gap-3 shrink-0 group" onClick={() => setOpen(false)}>
          <div className="grid h-12 w-12 shrink-0 place-items-center self-center rounded-full bg-white/95 p-1 shadow-md ring-1 ring-gold/40 transition group-hover:ring-gold">
            <img src={logo.url} alt="Badaie" className="h-full w-full object-cover rounded-full" />
          </div>
          <div className="flex flex-col justify-center min-w-0 leading-tight">
            <div className="text-white font-display text-base sm:text-lg font-semibold tracking-tight whitespace-nowrap">Badaie</div>
            <div className="text-gold text-[9px] sm:text-[10px] tracking-[0.18em] sm:tracking-[0.28em] uppercase whitespace-nowrap">HEAVY GEN.CONT.EST</div>
          </div>
        </Link>
